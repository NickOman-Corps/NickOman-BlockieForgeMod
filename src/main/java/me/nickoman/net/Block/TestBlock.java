...
public class TestBlock {
    ...
    public static final RegistryObject<Block> EXAMPLE_BLOCK = register("amongus_amongus",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_PURPLE).strength(3.0f).speedFactor(3.0f).sound(SoundType.AMETHYST)),
